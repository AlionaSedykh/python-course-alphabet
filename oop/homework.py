...
class Cat:
    ...
    * Implement get_average_speed and return average_speed
    ...
    def run(self, hours):
        ran_km = int(hours * self.average_speed)
        if ran_km <= 25:
...
class Wall:
    ...
    * Implement method number_of_rolls_of_wallpaper which receives such parameters: roll_width_m, roll_length_m
    ...
    def number_of_rolls_of_wallpaper(self, roll_width_m, roll_length_m):
        count_of_lines_in_roll = floor(roll_length_m / self.height)
        count_of_lines = floor(self.width / roll_width_m)
...
print(house.get_room_square())
print(house.get_number_of_rolls_of_wallpapers(0.53, 10))
